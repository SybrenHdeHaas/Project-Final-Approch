...
public class ColliderBreakable : ColliderObject
{
    GameObject thisObject;
    public float width;
    public float height;
    public ColliderBreakable(GameObject pRectObject, Vec2 pPosition, Vec2 pVelocity, float pWidth, float pHeight, bool pMoving, float pDensity = 1) : base(pPosition, pVelocity, pMoving, pDensity)
    {
